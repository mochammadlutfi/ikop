...
<div class="bg-body-light border-b">
    <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
            <span class="breadcrumb-item active">Transaksi Selesai</span>
        </nav>
    </div>
</div>
...
<div class="content">
    ...
    <input type="hidden" id="transaksi_type" value="selesai">
            ...
            <table class="table table-striped table-vcenter table-hover mb-0 font-size-sm" id="data-list">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th>Anggota</th>
                        <th>Tipe</th>
                        <th width="80px">Status Pembayaran</th>
                        <th width="80px">Metode Pembayaran</th>
                        <th>Status</th>
