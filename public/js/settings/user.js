jQuery(function() { 
    ...
    $(document).on('click', '#btn-edit', function () {
        ...
        $.ajax({
            url: laroute.route('settings.user.edit', { id: id }),
            type: "GET",
            dataType: "JSON",
            beforeSend: function(){
                Swal.fire({
    ...
    $(document).on('click', '#btn-delete', function () {
        ...
        .then((result) => {
            if (result.value) {
            $.ajax({
                url: laroute.route('settings.user.delete', { id: id }),
                type: "GET",
                dataType: "JSON",
                beforeSend: function(){
                    Swal.fire({
    ...
    $('#btn-add').on("click", function(){
        ...
        modal.find('#show_hide_password').parent().show();
        modal.modal({
            backdrop: 'static',
            keyboard: false
        });
    ...
    $("#form-user").on("submit", function (e) {
        ...
        {
            url = laroute.route('settings.user.update');
        }else{
            url = laroute.route('settings.user.store');
        }
...
function load_content(){
    ...
    $.ajax({
        url: laroute.route('settings.user'),
        type: "GET",
        dataType: "JSON",
        data: {
            keyword: keyword,
