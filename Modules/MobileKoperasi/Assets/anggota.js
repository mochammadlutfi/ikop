jQuery(function() { 
    ...
    $(document).on('click', '#btn-edit', function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                modal.find('h5.modal-title').html('Ubah Anggota');
    ...
    $('#btn-add').on("click", function(){
        ...
        $('#modal_title').text('Tambah Anggota Baru');
        modal.modal({
            backdrop: 'static',
            keyboard: false
        });
    ...
    $("#form-user").on("submit", function (e) {
        ...
        {
            url = laroute.route('mobile.anggota.update');
        }else{
            url = laroute.route('mobile.anggota.store');
        }
...
function load_content(){
    ...
    $.ajax({
        url: laroute.route('mobile.anggota'),
        type: "GET",
        dataType: "JSON",
        data: {
            keyword: keyword,
                ...
                $.each(response.data, function(k, v) {
                    $('#data-list tbody').append(`
                        <tr>
                            ...
                            <td>${ response.data[k].anggota.nama }</td>
                            <td>${ response.data[k].no_hp }</td>
