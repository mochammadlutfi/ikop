...
class PembiayaanController extends Controller
{
    ...
    public function list_detail($slug,Request $request)
    {
        ...
        if($request->slug == 'tunai'){
            ...
            $pengajuan = PmbTunai::select('no_pembiayaan', 'id', 'durasi', 'jumlah', 'created_at')->where('anggota_id', $anggota_id)->where('status', 0)->limit(2)->get();
            ...
            $tagihan = $tagihan->get();
            // $tagihan = ;
            // $tagihan->total = (int)$tagihan->total;
