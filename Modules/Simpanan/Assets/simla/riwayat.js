                ...
                $.each(response.data, function(k, v) {
                    $('#data-list tbody').append(`
                        <tr>
                            ...
                            <td><div class="currency">${ response.data[k].simla.amount }</div></td>
                            <td>${ response.data[k].teller.nama }</td>
                            <td class="text-center">
                                <a class="btn btn-secondary btn-sm js-tooltip" data-toggle="tooltip" data-placement="top" title="Detail Transaksi" href="${ laroute.route('simla.invoice', { id: response.data[k].no_transaksi }) }">
                ...
                <tr>
                    <td colspan="8">
                        <div class="text-center">
                            <img class="img-fluid" src="`+ laroute.url('public/media/placeholder/not_found.png', ['']) +`">
                            <div>
