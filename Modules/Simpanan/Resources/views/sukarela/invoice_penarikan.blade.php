    ...
    <div class="block">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <a class="btn-block-option" href="{{ route('admin.simla.invoice_print', $invoice->no_transaksi) }}" target="_blank">
        ...
        <div class="block-content pb-15">
            <!-- Invoice Info -->
            <div class="row justify-content-center py-20" style="background-color: #f6f7f9;">
                <div class="col-lg-6">
                    <div class="p-15">
                        <h2 class="text-left font-w700 mb-0">SLIP PENARIKAN</h2>
                    ...
                    <div class="box">
                        <table style="width:100%">
                            <tr>
                                ...
                                <td>: Rp <span class="display_currency">{{ abs($pay->jumlah) }}</span></td>
                            </tr>
                        </table>
                    </div>
                    <div class="box">
                        <table style="width:100%">
                            <tr>
                                ...
                                <td>: {{ ucwords(TransaksiHelp::terbilang($pay->jumlah)) }} Rupiah
                                </td>
                            </tr>
                        </table>
                    </div>
