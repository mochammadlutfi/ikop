...
<head>
    <meta charset="utf-8">
    <title>SLIP PENARIKAN - {{ $invoice->no_transaksi }}</title>
        ...
        <table width="100%" style="padding:10px 15px 10px 15px;">
            <tr>
                <td align="left" style="width: 60%;">
                    <h4 class="text-left font-w700 mb-0">SLIP PENARIKAN</h4>
                            ...
                            <td>
                                <table style="width:100%">
                                    <tr class="garis">
                                        ...
                                        <td>: {{ $pay->no_transaksi }}</td>
                                    </tr>
                                    <tr class="garis">
                                        <td width="30%"><b>Jumlah</b></td>
                                        <td>: Rp {{ number_format(abs($pay->jumlah),0,",",".") }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td class="garis">
                                <table style="width:100%">
                                    <tr>
                                        ...
                                        <td>: {{ ucwords(TransaksiHelp::terbilang($pay->jumlah)) }} Rupiah </td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
