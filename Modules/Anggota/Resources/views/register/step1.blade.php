    ...
    <div class="block mb-lg-1">
        <div class="block-content p-0">
            ...
            <ul class="nav nav-tabs nav-tabs-alt nav-fill nav-tabs-block">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('anggota.tambah') }}">1. Data Pribadi</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control" id="field-pendidikan" name="pendidikan" style="width: 100%;" data-placeholder="Pilih..">
                                    ...
                                    <option {{ !empty($anggota['pendidikan']) && $anggota['pendidikan'] === 'SD' ? 'selected="selected"' : ''}} value="SD">SD</option>
