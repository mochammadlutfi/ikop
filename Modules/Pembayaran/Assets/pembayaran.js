                ...
                $.each(response.data, function(k, v) {
                    $('#data-list tbody').append(`
                        <tr>
                            ...
                            <td>
                                ${ response.data[k].type.toLowerCase().replace(/\b[a-z]/g, function(letter) {
                            ...
                            <td class="text-center">
                                <a class="btn btn-secondary btn-sm js-tooltip" data-toggle="tooltip" data-placement="top" title="Detail Transaksi" href="${ laroute.route('simla.invoice', { id: response.data[k].id }) }">
