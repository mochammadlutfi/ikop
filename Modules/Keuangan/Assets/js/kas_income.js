jQuery(function() { 
    ...
    $(document).on('click', '#btn-edit', function () {
        ...
        $.ajax({
            url: laroute.route('kas.income.edit', { id: id }),
            type: "GET",
            dataType: "JSON",
            beforeSend: function(){
                Swal.fire({
            ...
            success: function(data) {
                ...
                modal.find('#modal_title').text('Ubah Pemasukan Kas');
    ...
    $("#form-kas").on("submit", function (e) {
        ...
        {
            url = laroute.route('kas.income.update');
        }else{
            url = laroute.route('kas.income.store');
        }
...
function detail(id){
    window.document.location = laroute.route('kas.income.detail', { id: id });
}