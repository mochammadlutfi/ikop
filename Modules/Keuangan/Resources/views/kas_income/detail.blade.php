        ...
        <div class="bg-body-light block-content">
            <div class="row no-gutters py-15 ">
                <div class="col-lg-6 d-flex">
                    <div class="my-auto">
                        <h2 class="font-w700 my-auto text-left">BUKTI PEMASUKAN KAS</h2>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="float-right">
...
@include('keuangan::kas_income.form')
@stop
@push('scripts')
...
<script src="{{ Module::asset('Keuangan:Assets/js/kas_income.js') }}"></script>
@endpush
