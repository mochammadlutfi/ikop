...
class KasExpenseController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('keuangan::kas_expense.index');
    }
    ...
    public function detail($id)
    {
        ...
        return view('keuangan::kas_expense.detail', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pesan = [
            'tgl.required' => 'Tanggal Pengeluaran Kas Wajib Diisi!',
            'nominal.required' => 'Nominal Pengeluaran Kas Wajib Diisi!',
            'keterangan.required' => 'Keterangan Pengeluaran Kas Wajib Diisi!',
            'akun_id.required' => 'Akun Pengeluaran Kas Wajib Diisi!',
        ...
        if ($validator->fails()){
            ...
            try{
                ...
                $data->kd_trans_kas = get_no_transaksi_kas('pengeluaran');
